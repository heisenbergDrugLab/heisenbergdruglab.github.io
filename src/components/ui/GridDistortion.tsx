...
const GridDistortion: React.FC<GridDistortionProps> = ({
    ...
    useEffect(() => {
        ...
        const handleResize = () => {
            ...
            // Scale plane to cover container (like object-fit: cover)
            if (plane) {
                let scaleX = 1;
                let scaleY = 1;

                if (containerAspect > imageAspect) {
                    // Container is wider than image - scale based on width
                    scaleX = containerAspect;
                    scaleY = containerAspect / imageAspect;
                } else {
                    // Container is taller than image - scale based on height
                    scaleX = imageAspect;
                    scaleY = 1;
                }
